...
double Particle::masses[7]={-1,0,1,0,-1,0,-1};//masses of differents types of particle
double Particle::scale_speeds[7]={0.02,-0.02,-0.01,0,-0.05,-0.001,0};// differents types of particle
double Particle::alpha_speeds[7]={3,10,0,3,1,0.5,5};// differents types of particle
double Particle::angle_speeds[7]={0,3,8,0,0,4,1};// differents types of particle
...
bool Particle::load_particle_animations()
{
    ...
    Animation *anim7=new Animation();
    anim7->load_animation("data/divers/money.png",42,16);
	//anim7->load_animation("data/divers/snowflake.png",30,26);
    particle_anims.push_back(anim7);
