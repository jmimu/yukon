...
class Particle: public Phys_Object
{
	...
	private:
		...
		static double masses[7];//masses of differents types of particle
		static double scale_speeds[7];// differents types of particle
		static double alpha_speeds[7];// differents types of particle
		static double angle_speeds[7];// differents types of particle
};
